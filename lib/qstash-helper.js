...
export function generateTube360QuoteEmailTemplates(data, options = {}) {
    const { ref, contact = {}, spec = {}, labels = {}, notes = '', files = [], folderUrl = '', submittedAt } = data || {};
        ...
        <body style="margin: 0; padding: 0; background-color: #f4f4f4; font-family: Arial, Helvetica, sans-serif;">
            <div style="max-width: 640px; margin: 0 auto; background-color: #ffffff;">
                <div style="background: linear-gradient(135deg, #1a1a1a 0%, #333333 100%); padding: 26px; text-align: center;">
                    <h1 style="color: #ffffff; margin: 0; font-size: 22px;">&#x1F4CE; Tube360 quote request</h1>
                    <p style="color: #facc15; margin: 8px 0 0 0; font-size: 16px; font-weight: bold;">${tube360Html(ref)}</p>
                    ${testBanner}
                </div>
                <div style="padding: 24px;">
        ...
        <body style="margin: 0; padding: 0; background-color: #f4f4f4; font-family: Arial, Helvetica, sans-serif;">
            <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
                <div style="background: linear-gradient(135deg, #1a1a1a 0%, #333333 100%); padding: 30px; text-align: center;">
                    ...
                    <h1 style="color: #ffffff; margin: 0; font-size: 24px;">We&#x2019;ve received your drawing</h1>
                    ${testBanner}
                </div>
                <div style="padding: 30px;">
