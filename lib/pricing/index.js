...
//   TUBE360 lines set isSteelTubesLineOverLength when one tube is longer than rates.json oversizeFreightThresholdMm (1000).
// ============================================================================
...
const { priceTube360Line } = require('./tube360');
  ...
  for (const item of items) {
    ...
    switch (item && item.kind) {
      ...
      case 'hose360':
        ...
        break;
      case 'tube360':
        priced = await priceTube360Line(item);
        break;
      default:
...
module.exports = { priceCart, PricingError, STEEL_TUBES_SHIPPING };
