...
/** Turn a request Origin into the right frontend base URL to build links from. */
...
module.exports = { applyCors, rejectMethod, getClientIp, createRateLimiter, isAllowedOrigin, resolveSiteBase };
